...
const DICT = {
  en: {
    ...
    onlineShort: 'online',
    shareCta: 'Create your tile 👉', shareBuilding: 'one giant mosaic',
    shareText: '🎨 Create your own tile and add it to our giant canvas — then share it with others! 👇',
    cardTagline: 'Everyone paints a tile. Together, one giant mosaic.',
    myTile: '🎨 My tile', mosaicHint: 'Everyone paints their own tile — together they make one big picture. Tap a tile to ❤️ it.',
    editorTitle: 'Your tile', editDone: 'Done', eraser: 'Eraser', tilesCount: 'tiles', tileLikes: 'likes',
    ...
    rulesTitle: 'How it works', rulesCta: 'Want to change the rules? Propose it 👇',
    rules: [
      '🧩 A shared mosaic — you paint your OWN 16×16 tile, however you like.',
      '🎨 Tap "My tile" to open it. Any color, as many pixels as you want — no limit.',
      '🖌️ Tap a cell to color it, tap again to erase, or pick the 🩹 eraser.',
      '❤️ Tap other people\'s tiles in the mosaic to like them.',
      '🌍 All tiles join into one big picture that grows as more people paint.',
      '⏳ The 24h timer restarts whenever a new person joins. It\'s anonymous.',
    ],
    proto: '⚠️ Web app built entirely with AI',
    feedback: '💬 Feedback',
    ...
    labDays: 'DAYS', labHrs: 'HRS', labMin: 'MIN', labSec: 'SEC',
  ...
  it: {
    ...
    onlineShort: 'online',
    shareCta: 'Crea la tua tessera 👉', shareBuilding: 'un mosaico gigante',
    shareText: '🎨 Crea la tua tessera e uniscila alla nostra tela gigante — poi condividila con gli altri! 👇',
    cardTagline: 'Ognuno dipinge una tessera. Insieme, un mosaico gigante.',
    myTile: '🎨 La mia tessera', mosaicHint: 'Ognuno dipinge la sua tessera — insieme formano un\'unica grande immagine. Tocca una tessera per mettere ❤️.',
    editorTitle: 'La tua tessera', editDone: 'Fatto', eraser: 'Gomma', tilesCount: 'tessere', tileLikes: 'like',
    ...
    rulesTitle: 'Come funziona', rulesCta: 'Vuoi cambiare le regole? Proponilo 👇',
    rules: [
      '🧩 Un mosaico condiviso — dipingi la TUA tessera 16×16, come vuoi tu.',
      '🎨 Tocca "La mia tessera" per aprirla. Qualsiasi colore, quanti pixel vuoi — nessun limite.',
      '🖌️ Tocca una cella per colorarla, tocca di nuovo per cancellare, o usa la 🩹 gomma.',
      '❤️ Tocca le tessere degli altri nel mosaico per mettere like.',
      '🌍 Tutte le tessere si uniscono in una grande immagine che cresce.',
      '⏳ Il timer di 24h riparte ogni volta che entra una persona nuova. È anonimo.',
    ],
    proto: '⚠️ Web app creata interamente con l\'AI',
    feedback: '💬 Feedback',
    ...
    labDays: 'GIORNI', labHrs: 'ORE', labMin: 'MIN', labSec: 'SEC',
  ...
  ro: {
    ...
    onlineShort: 'online',
    shareCta: 'Creează-ți tesera 👉', shareBuilding: 'un mozaic uriaș',
    shareText: '🎨 Creează-ți propria tesera și adaug-o pe pânza noastră uriașă — apoi distribuie-o altora! 👇',
    cardTagline: 'Fiecare pictează o tesera. Împreună, un mozaic uriaș.',
    myTile: '🎨 Tesera mea', mosaicHint: 'Fiecare își pictează tesera — împreună formează o singură imagine mare. Atinge o tesera ca să pui ❤️.',
    editorTitle: 'Tesera ta', editDone: 'Gata', eraser: 'Radieră', tilesCount: 'tesere', tileLikes: 'like-uri',
    ...
    rulesTitle: 'Cum funcționează', rulesCta: 'Vrei să schimbi regulile? Propune 👇',
    rules: [
      '🧩 Un mozaic comun — îți pictezi PROPRIA tesera 16×16, cum vrei.',
      '🎨 Atinge „Tesera mea" ca s-o deschizi. Orice culoare, câți pixeli vrei — fără limită.',
      '🖌️ Atinge o celulă ca s-o colorezi, atinge din nou ca s-o ștergi, sau folosește 🩹 radiera.',
      '❤️ Atinge teserele altora din mozaic ca să le dai like.',
      '🌍 Toate teserele se unesc într-o imagine mare care crește.',
      '⏳ Timerul de 24h repornește când intră o persoană nouă. Este anonim.',
    ],
    proto: '⚠️ Aplicație web creată în întregime cu AI',
    feedback: '💬 Feedback',
    ...
    labDays: 'ZILE', labHrs: 'ORE', labMin: 'MIN', labSec: 'SEC',
