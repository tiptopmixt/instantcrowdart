...
const DICT = {
  en: {
    ...
    onlineShort: 'online',
    shareCta: 'Draw with us 👉', shareBuilding: 'drawn together in 24h',
    shareText: '⚡ Come draw with us! 🎨 A shared pixel canvas — you get 10 pixels, add yours before it\'s gone 👇',
    cardTagline: 'A shared pixel canvas. 10 pixels each. Draw it together!',
    ...
    rules: [
      '🎨 A shared pixel canvas — the whole crowd draws ONE picture together.',
      '⚡ You have 10 pixels. Pick a color and tap the canvas to place one.',
      '✋ Tap any pixel to pick it up, then tap an empty cell to move it — yes, even other people\'s (once every 8s).',
      '🗑️ Tap your own picked-up pixel again to remove it (frees a pixel).',
      '🌱 The board grows as it fills, so there\'s always room.',
      '⏳ After 24 hours everything is gone. It\'s anonymous — no names.',
    ],
  ...
  it: {
    ...
    onlineShort: 'online',
    shareCta: 'Disegna con noi 👉', shareBuilding: 'disegnata insieme in 24h',
    shareText: '⚡ Vieni a disegnare con noi! 🎨 Una tela di pixel condivisa — hai 10 pixel, mettili prima che sparisca 👇',
    cardTagline: 'Una tela di pixel condivisa. 10 pixel a testa. Disegnamola insieme!',
    ...
    rules: [
      '🎨 Una lavagna di pixel condivisa — tutta la folla disegna UN\'unica immagine insieme.',
      '⚡ Hai 10 pixel. Scegli un colore e tocca la tela per piazzarne uno.',
      '✋ Tocca un pixel per prenderlo, poi tocca una cella vuota per spostarlo — sì, anche quelli degli altri (una volta ogni 8s).',
      '🗑️ Tocca di nuovo il tuo pixel preso per rimuoverlo (liberi un pixel).',
      '🌱 La lavagna diventa più grande man mano che si riempie, così c\'è sempre spazio.',
      '⏳ Dopo 24 ore sparisce tutto. È anonima — nessun nome.',
    ],
  ...
  ro: {
    ...
    onlineShort: 'online',
    shareCta: 'Desenează cu noi 👉', shareBuilding: 'desenată împreună în 24h',
    shareText: '⚡ Vino să desenăm împreună! 🎨 O pânză de pixeli comună — ai 10 pixeli, pune-i înainte să dispară 👇',
    cardTagline: 'O pânză de pixeli comună. 10 pixeli fiecare. S-o desenăm împreună!',
    ...
    rules: [
      '🎨 O pânză de pixeli comună — toată mulțimea desenează O singură imagine împreună.',
      '⚡ Ai 10 pixeli. Alege o culoare și atinge pânza pentru a plasa unul.',
      '✋ Atinge orice pixel pentru a-l ridica, apoi atinge o celulă goală ca să-l muți — da, chiar și pe ai altora (o dată la 8s).',
      '🗑️ Atinge din nou pixelul ridicat al tău ca să-l ștergi (eliberezi un pixel).',
      '🌱 Tabla se mărește pe măsură ce se umple, așa că e mereu loc.',
      '⏳ După 24 de ore totul dispare. Este anonimă — fără nume.',
    ],
