...
const DICT = {
  ...
  ro: {
    ...
    onlineShort: 'online',
    shareCta: 'Creează-ți foaia 👉', shareBuilding: 'un mozaic uriaș',
    shareText: '🎨 Creează-ți propria foaie și adaug-o pe pânza noastră uriașă — apoi distribuie-o altora! 👇',
    cardTagline: 'Fiecare pictează o foaie. Împreună, un mozaic uriaș.',
    myTile: '🎨 Foaia mea', mosaicHint: 'Fiecare își pictează foaia — împreună formează o singură imagine mare. Atinge o foaie ca să pui ❤️.',
    editorTitle: 'Foaia ta', editDone: 'Gata', eraser: 'Radieră', tilesCount: 'foi', tileLikes: 'like-uri',
    ...
    rules: [
      '🧩 Un mozaic comun — îți pictezi PROPRIA foaie 16×16, cum vrei.',
      '🎨 Atinge „Foaia mea" ca s-o deschizi. Orice culoare, câți pixeli vrei — fără limită.',
      '🖌️ Atinge o celulă ca s-o colorezi, atinge din nou ca s-o ștergi, sau folosește 🩹 radiera.',
      '❤️ Atinge foile altora din mozaic ca să le dai like.',
      '🌍 Toate foile se unesc într-o imagine mare care crește.',
