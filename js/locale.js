...
const DICT = {
  en: {
    ...
    rules: [
      ...
      '⏳ The 7-day timer restarts whenever a new person joins. It\'s anonymous.',
    ],
  ...
  it: {
    ...
    rules: [
      ...
      '⏳ Il timer di 7 giorni riparte ogni volta che entra una persona nuova. È anonimo.',
    ],
  ...
  ro: {
    ...
    onlineShort: 'online',
    shareCta: 'Creează-ți piesa 👉', shareBuilding: 'un mozaic uriaș',
    shareText: '🎨 Creează-ți propria piesă și adaug-o pe pânza noastră uriașă — apoi distribuie-o altora! 👇',
    cardTagline: 'Fiecare pictează o piesă. Împreună, un mozaic uriaș.',
    myTile: '🎨 Piesa mea', mosaicHint: 'Fiecare își pictează piesa — împreună formează o singură imagine mare. Atinge o piesă ca să pui ❤️.',
    editorTitle: 'Piesa ta', editDone: 'Gata', eraser: 'Radieră', tilesCount: 'piese', tileLikes: 'like-uri',
    ...
    rules: [
      '🧩 Un mozaic comun — îți pictezi PROPRIA piesă 16×16, cum vrei.',
      '🎨 Atinge „Piesa mea" ca s-o deschizi. Orice culoare, câți pixeli vrei — fără limită.',
      '🖌️ Atinge o celulă ca s-o colorezi, atinge din nou ca s-o ștergi, sau folosește 🩹 radiera.',
      '❤️ Atinge piesele altora din mozaic ca să le dai like.',
      '🌍 Toate piesele se unesc într-o imagine mare care crește.',
      '⏳ Timerul de 7 zile repornește când intră o persoană nouă. Este anonim.',
    ],
